        ...
        <div className="relative flex">
          ...
          <div className="flex-1 flex flex-col gap-10 ">
            {Journeys.map((exp, i) => (
              ...
              >
                {/* Card */}
                <div className="text-left w-full p-5 bg-white border-2 border-gray-900 shadow-lg rounded-lg">
                  ...
                  <motion.h3
                    ...
                    className="text-lg font-bold font-quantico text-gray-900 mb-1"
                  >
                    {exp.job}
                  </motion.h3>
                  ...
                  <motion.div
                    ...
                    className="flex flex-row gap-1.5 font-quantico text-gray-600"
                  >
